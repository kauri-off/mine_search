    ...
    <Modal isOpen={isOpen} onClose={handleClose} title={t.addIp.label}>
      <form onSubmit={handleSubmit} className="space-y-4">
        <input
          ...
          className="w-full bg-surface border border-border rounded-lg px-3 py-2.5 text-sm text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
        />
