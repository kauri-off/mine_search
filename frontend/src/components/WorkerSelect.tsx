    ...
    <div className="space-y-1.5">
      ...
      {online.length === 0 ? (
        ...
        <select
          ...
          className="w-full bg-[#1a1a24] border border-[#2a2a3a] rounded-lg px-3 py-2.5 text-sm text-slate-200 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
        >
