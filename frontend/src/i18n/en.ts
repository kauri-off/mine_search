...
export const en: Translations = {
  ...
  workers: {
    ...
    updateConcurrency: "Update concurrency",
    searchModule: "Search module",
    updateModule: "Update module",
    withConnection: "Update with connection",
    onlySpoofable: "Only spoofable",
    onlyCracked: "Only cracked",
    save: "Apply config",
    saving: "Applying...",
